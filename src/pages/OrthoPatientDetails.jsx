...
const isAllowedMediaFile = (
  ...
  return ALLOWED_MEDIA_EXTENSIONS.includes(
    extension,
  );
};

const isAllowedMediaSize = (
  file,
) => {
  if (!file?.size) {
    return true;
  ...
  () => {
      ...
      async () => {
        try {
          ...
          const payload = {
            ...
            next_visit_plan:
              clean(
                values.next_visit_plan,
              ),
          };

          await createOrthoVisit(
            caseId,
            payload,
          );

          message.success(
            "Ortho visit added successfully.",
          );
      ...
      async () => {
        try {
          ...
          const payload = {
            ortho_visit_id:
              clean(
                values.ortho_visit_id,
              ),

            payment_date:
              values.payment_date
                ? values.payment_date.format(
                    "YYYY-MM-DD",
                  )
                : dayjs().format(
                    "YYYY-MM-DD",
          ...
          await createOrthoPayment(
            caseId,
            payload,
          );

          message.success(
            "Ortho payment added successfully.",
          );
    ...
    const handleBeforeMediaUpload =
      (file) => {
        ...
        if (
          ...
          message.warning(
            `Maximum ${MAX_MEDIA_FILES} files are allowed.`,
          );
    ...
    const handleUploadMedia =
      async () => {
        try {
          const values =
            await mediaForm.validateFields();
    ...
    const handleDownloadMedia =
      async (record) => {
        ...
        try {
          ...
          console.error(
            "Failed to download Ortho media:",
            err,
          );
    ...
    const handleDeleteMedia =
      async (record) => {
        ...
        try {
          ...
          await deleteOrthoMedia(
            mediaId,
          );

          message.success(
            "Ortho media deleted successfully.",
          );

          if (
            previewMedia?.ortho_media_id ===
            mediaId
          ) {
            handleClosePreview();
          }
    ...
    const visitColumns = [
...

      {
        ...
        render: (
          ...
          <div className="ortho-table-notes">
            {value ||
              "-"}
          </div>
        ),
            ...
            (
              ...
              children: (
                <div className="ortho-timeline-card">
                  ...
                  <Title
                    level={5}
                    className="ortho-timeline-title"
                  >
                    {visit.procedure ||
                      "Orthodontic Visit"}
                  </Title>
                  ...
                  <div className="ortho-payment-overview">
                    ...
                    <div className="ortho-payment-grid">
                      ...
                      <div>
                        ...
                        <Text
                          strong
                          className="ortho-payment-balance"
                        >
                          {formatMoney(
                            financials.balance,
                          )}
        ...
        children: (
          <div className="ortho-tab-content">
            ...
            <Row
              ...
              className="ortho-payment-stat-row"
            >
              <Col
                xs={24}
                md={8}
    ...
    return (
      <div className="ortho-details-page">
        ...
        >
          ...
          >
            <Card className="ortho-summary-card">
              ...
              <Text type="secondary">
                Complete Ortho treatment history
              </Text>
            </Card>
          </Col>
        ...
        <Row
          ...
          className="ortho-visit-status-row"
        >
          <Col
            xs={24}
            lg={12}
          >
            <Card className="ortho-visit-highlight-card">
              ...
              <div className="ortho-highlight-content">
                ...
                <Title
                  level={4}
                  className="ortho-highlight-title"
                >
                  {lastVisit
                    ? formatDate(
                        lastVisit.visit_date,
                  ...
                  <Select
                    ...
                    options={visits.map(
                      (
                        ...
                        value:
                          visit.ortho_visit_id,

                        label:
                          `Visit #${visit.visit_number} - ${formatDate(
                            visit.visit_date,
                          )}`,
                      }),
                    )}
                  ...
                  rules={[
                    {
                      ...
                      message:
                        "Please select the treatment stage.",
                    },
                  ]}
                >
                  <Select
