...
const PatientHistory = () => {
  ...
  const doctorNotes = Array.isArray(
  ...
  /* --------------------------------------------------------
     Doctor notes columns
  -------------------------------------------------------- */

  const doctorNoteColumns = [
    {
      title: "Treatment Date",
      dataIndex: "treatment_date",
      key: "treatment_date",
  ...
  return (
    <ClinicPage
      ...
      subtitle="Search a patient and review their complete clinical and payment history."
